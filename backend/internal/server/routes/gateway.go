...
func RegisterGatewayRoutes(
	...
	gateway.Use(requireGroupAnthropic)
	{
		...
		gateway.GET("/images/models", h.Gateway.ImageModels)
		...
		gateway.GET("/videos/models", h.Gateway.VideoModels)
	...
	r.GET("/images/models", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, h.Gateway.ImageModels)
	...
	r.GET("/videos/models", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, h.Gateway.VideoModels)
