...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/inspoaibox/sub2api-new:latest
...
SUB2API_IMAGE=ghcr.io/inspoaibox/sub2api-new:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
