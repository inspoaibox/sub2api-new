...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/inspoaibox/sub2api-new/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="${SUB2API_UPDATE_REPOSITORY:-inspoaibox/sub2api-new}"
...
Documentation=https://github.com/inspoaibox/sub2api-new
