export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'When multiple users share the same OAuth account, this can converge device/session identifiers to account-level stable values to reduce upstream-visible device and session count. It is off by default and passes client identifiers through unchanged.',
        codexFingerprintOff: 'Off (default, passthrough)',
