export default {
  ...
  nav: {
    ...
    apiKeys: 'API Keys',
    aiImageWorkbench: 'AI Drawing',
    aiVideoWorkbench: 'AI Video',
    aiImageWorkbenchDescription: 'Create images from text or continue creating and editing from a source image',
    aiVideoWorkbenchDescription: 'Create video from a text prompt or reference image',
  ...
  aiWorkbench: {
    ...
    noKeyTitle: 'No API key is available for this capability',
    noImageKey: 'Create or enable an OpenAI, Grok, or composite API key that permits image generation.',
    noVideoKey: 'Create or enable a Grok or composite API key that permits media generation.',
    ...
    loadModelsFailed: 'Failed to load available models. Please try again.',
    noModels: 'No available models',
    noModelsForKey: 'No usable media model is available for this API key group.',
    prompt: 'Prompt',
    promptLibrary: 'Prompt Library',
    openPromptLibrary: 'Open prompt library',
    searchPrompts: 'Search titles, prompts, or tags',
    replacePrompt: 'Replace',
    appendPrompt: 'Append',
    promptCategory: 'Category',
    promptTags: 'Tags',
    promptCount: '{count} prompts',
    somePromptSourcesUnavailable: 'Some prompt sources are unavailable',
    usePrompt: 'Use',
    ...
    sourceImageHint: 'Uploading an image uses the image edit endpoint',
    referenceImageHint: 'Optional visual reference for the video',
    size: 'Size',
    imageResolution: 'Image resolution',
    imageResolutionHint: 'This is the requested pixel size. Support and final output depend on the selected model.',
    customResolution: 'Custom resolution',
    customResolutionHint: 'Enter whole-number dimensions from {min} to {max} px.',
    invalidCustomResolution: 'Width and height must be whole numbers from {min} to {max} px.',
    width: 'Width',
    height: 'Height',
    imageSize1024Square: '1K square · 1024 × 1024',
    imageSize1536Landscape: 'Landscape · 1536 × 1024',
    imageSize1536Portrait: 'Portrait · 1024 × 1536',
    imageSize2048Square: '2K square · 2048 × 2048',
    imageSize2560Wide: '2K wide · 2560 × 1440',
    imageSize3840Wide: '4K wide · 3840 × 2160',
    count: 'Count',
    quality: 'Image detail',
    qualityHint: 'Image detail affects generated texture and time, not the selected pixel resolution.',
    duration: 'Duration',
    resolution: 'Resolution',
    aspectRatio: 'Aspect Ratio',
    output: 'Output',
    sessionHistory: 'Generation History',
    clearHistory: 'Clear',
    ...
    useAsSource: 'Use as source image and continue editing',
    sourceImageReady: 'Source image is ready for editing',
    useAsSourceFailed: 'Could not use this image as the source image',
    downloadVideo: 'Download video',
    reuseSettings: 'Reuse settings',
    imagePromptPlaceholder: 'Describe the image you want to create or edit...',
    videoPromptPlaceholder: 'Describe the scene, action, camera, and visual style...',
    emptyImageTitle: 'Start an image creation',
    emptyImageDescription: 'Set a prompt, model, and parameters. Results appear here.',
    emptyVideoTitle: 'Start a video creation',
    emptyVideoDescription: 'Set a prompt and parameters. Your completed video will appear here.',
    renderingImage: 'Drawing image',
    renderingImageDescription: 'Connecting to the image model. A preview will appear as soon as it arrives.',
    refiningImage: 'Refining the final image...',
    renderingVideo: 'Generating video',
    renderingVideoDescription: 'The video task is processing and will load automatically when complete.',
    failedTitle: 'Generation did not complete',
    completeRequiredFields: 'Select an API key and provide a model and prompt',
    loadKeysFailed: 'Failed to load API keys',
    generateFailed: 'Generation failed. Please try again later.',
    invalidImage: 'Upload a PNG, JPG, or WebP image',
    imageTooLarge: 'Image must be no larger than 10 MB',
    emptyImageResponse: 'The API did not return an image result',
    missingVideoTask: 'The API did not return a video task ID to query',
    videoTaskFailed: 'The video task failed',
    videoTimeout: 'Timed out waiting for the video task. Please try again later.',
    generationInterrupted: 'The generation connection was interrupted by a page refresh. Please submit it again.',
    imageGenerated: 'Image generated',
    videoGenerated: 'Video generated',
    auto: 'Auto',
    qualityAuto: 'Auto (model decides)',
    square: 'Square',
    landscape: 'Landscape',
    portrait: 'Portrait',
    qualityLow: 'Standard detail (faster)',
    qualityMedium: 'Enhanced detail',
    qualityHigh: 'Fine detail (may take longer)',
    seconds: '{value} sec',
    wide: 'Wide 16:9',
    vertical: 'Vertical 9:16',
    squareVideo: 'Square 1:1',
