export default {
  ...
  version: {
    ...
    dockerModeHint: 'Docker deployments update by replacing the image; the binary is not replaced inside the container.',
    dockerUpdateCommand: 'Docker update command',
    dockerUpdateHint: 'This command backs up data, pulls the latest image from this repository, and recreates the services.',
  ...
  payment: {
    ...
    methods: {
      ...
      card: 'Card',
      link: 'Link',
      stripe_card: 'Card / Google Pay',
      stripe_alipay: 'Alipay (Stripe)',
      stripe_wxpay: 'WeChat Pay (Stripe)',
      stripe_link: 'Link',
