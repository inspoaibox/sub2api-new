export default {
  ...
  nav: {
    ...
    announcements: '公告',
    apiKeys: 'API 密钥',
    aiImageWorkbench: 'AI 绘图',
    aiVideoWorkbench: 'AI 视频',
    aiImageWorkbenchDescription: '通过文字描述生成图片，或基于源图片继续创作与编辑',
    aiVideoWorkbenchDescription: '通过文字描述或参考图片生成视频内容',
    batchImage: '批量生图',
    usage: '使用记录',
    redeem: '兑换',
    affiliate: '邀请返利',
  ...
  aiWorkbench: {
    ...
    noKeyTitle: '没有可用于此能力的 API 密钥',
    noImageKey: '请创建或启用一个允许图片生成的 OpenAI、Grok 或复合分组 API 密钥。',
    noVideoKey: '请创建或启用一个允许媒体生成的 Grok 或复合分组 API 密钥。',
    ...
    loadModelsFailed: '加载可用模型失败，请稍后重试。',
    noModels: '暂无可用模型',
    noModelsForKey: '当前 API 密钥所在分组没有可用的媒体模型。',
    prompt: '提示词',
    promptLibrary: '提示词库',
    openPromptLibrary: '打开提示词库',
    searchPrompts: '搜索标题、提示词或标签',
    replacePrompt: '替换',
    appendPrompt: '追加',
    promptCategory: '分类',
    promptTags: '标签',
    promptCount: '共 {count} 条提示词',
    somePromptSourcesUnavailable: '部分提示词来源暂不可用',
    usePrompt: '使用',
    ...
    sourceImage: '源图片',
    referenceImage: '参考图片',
    sourceImageHint: '上传图片后将使用图片编辑接口',
    referenceImageHint: '可选，作为视频的视觉参考',
    size: '尺寸',
    imageResolution: '图片尺寸',
    imageResolutionHint: '这里是请求的像素尺寸。实际支持范围和最终输出由所选模型决定。',
    customResolution: '自定义尺寸',
    customResolutionHint: '宽高可填写 {min}-{max} px 的整数。',
    invalidCustomResolution: '宽高必须是 {min}-{max} px 之间的整数。',
    width: '宽度',
    height: '高度',
    imageSize1024Square: '1K 正方形 · 1024 × 1024',
    imageSize1536Landscape: '横向 · 1536 × 1024',
    imageSize1536Portrait: '竖向 · 1024 × 1536',
    imageSize2048Square: '2K 正方形 · 2048 × 2048',
    imageSize2560Wide: '2K 横屏 · 2560 × 1440',
    imageSize3840Wide: '4K 横屏 · 3840 × 2160',
    count: '数量',
    quality: '画面细节',
    qualityHint: '画面细节影响模型生成的纹理和耗时，不改变所选的像素尺寸。',
    duration: '时长',
    resolution: '分辨率',
    aspectRatio: '画面比例',
    output: '生成结果',
    ...
    generating: '正在生成...',
    download: '下载图片',
    useAsSource: '设为源图片并继续编辑',
    sourceImageReady: '已设为源图片，可以继续编辑',
    useAsSourceFailed: '无法将这张图片设为源图片',
    downloadVideo: '下载视频',
    reuseSettings: '复用设置',
    imagePromptPlaceholder: '描述你想要生成或编辑的画面...',
    videoPromptPlaceholder: '描述场景、动作、镜头和画面风格...',
    emptyImageTitle: '开始一次图片创作',
    emptyImageDescription: '填写提示词，选择模型和参数后，结果会显示在这里。',
    emptyVideoTitle: '开始一次视频创作',
    emptyVideoDescription: '填写提示词并选择参数后，生成完成的视频会显示在这里。',
    renderingImage: '正在绘制图片',
    renderingImageDescription: '正在连接生成模型，收到预览后会立即显示。',
    refiningImage: '正在细化最终图片...',
    renderingVideo: '正在生成视频',
    renderingVideoDescription: '视频任务正在处理，完成后会自动加载。',
    failedTitle: '生成未完成',
    completeRequiredFields: '请选择 API 密钥并填写模型和提示词',
    loadKeysFailed: '加载 API 密钥失败',
    generateFailed: '生成失败，请稍后重试',
    invalidImage: '请上传 PNG、JPG 或 WebP 图片',
    imageTooLarge: '图片不能超过 10 MB',
    emptyImageResponse: '接口未返回图片结果',
    missingVideoTask: '接口未返回可查询的视频任务 ID',
    videoTaskFailed: '视频任务处理失败',
    videoTimeout: '视频任务等待超时，请稍后重试',
    generationInterrupted: '页面刷新导致生成连接中断，请重新提交。',
    imageGenerated: '图片生成完成',
    videoGenerated: '视频生成完成',
    auto: '自动',
    qualityAuto: '自动（由模型决定）',
    square: '正方形',
    landscape: '横向',
    portrait: '纵向',
    qualityLow: '标准细节（更快）',
    qualityMedium: '增强细节',
    qualityHigh: '精细细节（可能更慢）',
    seconds: '{value} 秒',
    wide: '横屏 16:9',
    vertical: '竖屏 9:16',
    squareVideo: '正方形 1:1',
