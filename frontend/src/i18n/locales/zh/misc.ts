export default {
  ...
  version: {
    ...
    refresh: '刷新',
    checkFailed: '版本检测暂不可用',
    sourceMode: '源码构建',
    sourceModeHint: '源码构建请使用 git pull 更新',
    dockerModeHint: 'Docker 部署通过更新镜像升级，容器内不会直接替换程序文件。',
    dockerUpdateCommand: 'Docker 更新命令',
    dockerUpdateHint: '该命令会备份数据、拉取二开仓库最新镜像并重新创建服务。',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
  ...
  payment: {
    ...
    methods: {
      ...
      card: '银行卡',
      link: 'Link',
      stripe_card: '银行卡 / Google Pay',
      stripe_alipay: '支付宝（Stripe）',
      stripe_wxpay: '微信支付（Stripe）',
      stripe_link: 'Link 快捷支付',
    ...
    errors: {
      ...
      PAYMENT_CONFIG_ENCRYPTION_KEY_NOT_CONFIGURED: '无法保存支付凭证：请先配置固定的 TOTP_ENCRYPTION_KEY 并重启服务',
